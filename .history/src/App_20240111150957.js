...
function App() {
  ...
  return (
    <div className="App">
     ...
     <NavBar scrollToProjectRef={scrollToProjectRef} scrollToSkillsRef={scrollToSkillsRef} scrollToContactFormRef={scrollToContactFormRef} scrollToHomeRef={scrollToHomeRef}/>
     </div>
