...
export const Skills=forwardRef(({},ref)=>{
    return(
        <>
         <h1 className={styles.header} ref={ref}>
            <Typewriter options={{
                autoStart:true,
                loop:true,
                delay:250,
         ...
         <Container className={styles.container}>
            <Row className={styles.skillrow}>
                ...
                <Col className={styles.skill}>
                    <img src={html} alt="" className={styles.skilllogo}/>
                    <span className={styles.skillname}>HTML</span>
                </Col>

                <Col className={styles.skill}>
                    <img src={css} alt="" className={styles.skilllogo} />
                    <span className={styles.skillname}>CSS</span>
                </Col>

                <Col className={styles.skill}>
                    <img src={js} alt="" className={styles.skilllogo}/>
            ...
            <Row className={styles.skillrow}>
                ...
                <Col className={styles.skill}>
                <img src={ts} alt="" className={styles.skilllogo} />
                <span className={styles.skillname}>TypeScript</span>
                </Col>
                <Col className={styles.skill}>
                <img src={node} alt="" className={styles.skilllogo} />
            ...
            <Row className={styles.skillrow}>
                <Col className={styles.skill}>
                <img src={python} alt="" className={styles.skilllogo} />
                <span className={styles.skillname}>Python</span>
                </Col>
                

                <Col className={styles.skill}>
                <img src={mysql} alt="" className={styles.skilllogo}/>
                <span className={styles.skillname}>MySql</span>
                </Col>
                <Col className={styles.skill}>
                <img src={sass} alt="" className={styles.skilllogo}/>
