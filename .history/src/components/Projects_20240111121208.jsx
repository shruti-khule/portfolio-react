...
const projects=[
    ...
    {
        title:"Amazon clone",
        description:"Built using ReactJS and Firebase, providing a comprehensive e-commerce experience",
        img:project_1,
                            ...
                            {projects.slice(0,3).map((project,index)=>{
                                ...
                                return(
                                   ...
                                   <Col key={index} className={styles.projcards}>
                                    ...
                                    <img src={project.img} alt={project.title} className={styles.projectimage} onClick={project.link}></img>
