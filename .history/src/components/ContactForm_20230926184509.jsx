            ...
            <Container ref={ref} className={styles.formcontainer}>
                ...
                <Row className={styles.row}>
                    ...
                    <form className={styles.inputs} onSubmit={sendEmail} ref={form}>
                        <Row >
                            <Col lg={6} id={styles.firstname}><input type="text" placeholder="First Name" value={formDetails.firstname} onChange={(e)=>updateDetails('firstname',e.target.value)} required name="firstname"></input></Col>
                            <Col lg={6} id={styles.lastname}><input type="text" placeholder="Last Name" value={formDetails.lastname} onChange={(e)=>updateDetails('lastname',e.target.value)} required name="lastname"></input></Col>
