                ...
                <Row className={styles.row}>
                    ...
                    <form className={styles.inputs} onSubmit={sendEmail} ref={form}>
                        <Row >
                            ...
                            <Col  id={styles.lastname}><input type="text" placeholder="Last Name" value={formDetails.lastname} onChange={(e)=>updateDetails('lastname',e.target.value)} required name="lastname"></input></Col>
